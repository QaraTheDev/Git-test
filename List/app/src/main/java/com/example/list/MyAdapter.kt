...
class MyAdapter(private val context : Activity, private val arrayList: ArrayList<User>) : ArrayAdapter<User>(context,
    ...
    override fun getView(positiion : Int, convertView: View?, parent: ViewGroup): View {
        ...
        imageView.setImageResource(arrayList[positiion].imageId)
        username.text = arrayList[positiion].name
        lastMsg.text = arrayList[positiion].lastMessage
        lastMsgTime.text = arrayList[positiion].lastMesTime
